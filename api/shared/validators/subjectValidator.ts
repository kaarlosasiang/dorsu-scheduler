...
export const createSubjectSchema = z.object({
  ...
  units: z.number().min(0, 'Units must be at least 0').max(12, 'Units cannot exceed 12'),
  ...
  isLaboratory: z.boolean().optional().default(false),
...
export const subjectQuerySchema = z.object({
  ...
  isLaboratory: z.enum(['true', 'false']).optional()
});
